---
title: "Ancient DNA & Sabretooth cats"
...
include_graphics("./img/studyspecies.svg")
```
...
## Ancient DNA can tell us about...<br> <span style="font-size: 40px; font-weight: normal;"> *Interbreeding & conservation practices* </span> {.flex-cols}


```{r, out.height = 400, fig.align='center', fig.cap="*www.lynxexsitu.es, CC BY-SA 3.0*"}
include_graphics("./img/Iberian_Lynx_full_body.JPG")
```
...
## Ancient DNA can tell us about... <br>  <span style="font-size: 40px; font-weight: normal;"> *Dwarfing on islands* </span>
...
## And we can do this stuff here in Bangor! {.columns-2}
...
- Pleistocene Europe & Asia: *H. latidens*, extinction 300 Ka
...
include_graphics("./img/aDNA_seq_JP.svg")
```
